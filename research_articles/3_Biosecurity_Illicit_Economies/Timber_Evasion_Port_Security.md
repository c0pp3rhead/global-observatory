...
![Chart](research_articles/3_Biosecurity_Illicit_Economies/images/timber_evasion_port_security.png)
...
Implementing **Timber Evasion Port Security** requires significant CAPEX, but the OPEX savings are non-linear.
