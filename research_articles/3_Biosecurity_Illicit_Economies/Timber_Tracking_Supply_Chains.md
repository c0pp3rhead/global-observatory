...
![Chart](research_articles/3_Biosecurity_Illicit_Economies/images/timber_tracking_supply_chains.png)
...
Implementing **Timber Tracking Supply Chains** requires significant CAPEX, but the OPEX savings are non-linear.
