...
![Chart](research_articles/3_Biosecurity_Illicit_Economies/images/timber_evasion_supply_chains.png)
...
Implementing **Timber Evasion Supply Chains** requires significant CAPEX, but the OPEX savings are non-linear.
