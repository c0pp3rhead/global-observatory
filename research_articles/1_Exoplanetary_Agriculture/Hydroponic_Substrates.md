...
**Category:** ISRU | **Read Time:** 5 min

## 🎓 Concept 101: The Basics
*We can't bring soil from Earth. We grind up Martian rocks (Basalt) and use that 'sand' to anchor plant roots.*

---

## 1. Technical Abstract
This research note evaluates **Hydroponic Substrates** within the context of ISRU. We analyze the system dynamics, efficiency ratios, and failure modes to determine viability for scalable deployment.
...
## 3. Data Analysis
![Chart](images/hydroponic_substrates.png)
