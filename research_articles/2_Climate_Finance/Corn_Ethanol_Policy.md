...
## 1. Executive Summary
This research note analyzes the financial materiality of **Corn Ethanol Policy**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/corn_ethanol_policy.png]
