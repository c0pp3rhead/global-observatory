...
## 1. Executive Summary
This research note analyzes the financial materiality of **Nuclear Small Modular Reactors**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/nuclear_small_modular_reactors.png]
