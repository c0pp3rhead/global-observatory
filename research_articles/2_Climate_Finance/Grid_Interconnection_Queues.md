...
## 1. Executive Summary
This research note analyzes the financial materiality of **Grid Interconnection Queues**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/grid_interconnection_queues.png]
