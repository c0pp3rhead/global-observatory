# Grid Derivatives Risk Premiums
...
![Chart](research_articles/2_Climate_Finance/images/grid_derivatives_risk_premiums.png)
...
Implementing **Grid Derivatives Risk Premiums** requires significant CAPEX, but the OPEX savings are non-linear.
