# Battery Arbitrage Transition Risks
...
![Chart](research_articles/2_Climate_Finance/images/battery_arbitrage_transition_risks.png)
...
Implementing **Battery Arbitrage Transition Risks** requires significant CAPEX, but the OPEX savings are non-linear.
