# Migrant Labor Migration
**Author:** Cristian Morales | **Category:** 🌡 Thermal Stress & Labor

## 1. Executive Summary
This research note analyzes the financial materiality of **Migrant Labor Migration**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/migrant_labor_migration.png]
