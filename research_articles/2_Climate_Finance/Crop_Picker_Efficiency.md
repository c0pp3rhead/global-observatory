# Crop Picker Efficiency
**Author:** Cristian Morales | **Category:** 🌡 Thermal Stress & Labor

## 1. Executive Summary
This research note analyzes the financial materiality of **Crop Picker Efficiency**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/crop_picker_efficiency.png]
