# Wheat Protein Heat Shock
**Author:** Cristian Morales | **Category:** ☕ Commodity Volatility

## 1. Executive Summary
This research note analyzes the financial materiality of **Wheat Protein Heat Shock**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/wheat_protein_heat_shock.png]
