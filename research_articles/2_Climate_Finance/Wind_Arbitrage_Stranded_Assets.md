# Wind Arbitrage Stranded Assets
...
![Chart](research_articles/2_Climate_Finance/images/wind_arbitrage_stranded_assets.png)
...
Implementing **Wind Arbitrage Stranded Assets** requires significant CAPEX, but the OPEX savings are non-linear.
