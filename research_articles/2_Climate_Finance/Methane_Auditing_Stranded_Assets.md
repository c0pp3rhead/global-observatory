# Methane Auditing Stranded Assets
...
![Chart](research_articles/2_Climate_Finance/images/methane_auditing_stranded_assets.png)
...
Implementing **Methane Auditing Stranded Assets** requires significant CAPEX, but the OPEX savings are non-linear.
