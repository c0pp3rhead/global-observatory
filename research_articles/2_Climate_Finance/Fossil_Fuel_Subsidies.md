...
## 1. Executive Summary
This research note analyzes the financial materiality of **Fossil Fuel Subsidies**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/fossil_fuel_subsidies.png]
