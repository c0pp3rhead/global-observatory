# Peaker Plant Obsolescence
**Author:** Cristian Morales | **Category:** ⚡ Energy Transition

## 1. Executive Summary
This research note analyzes the financial materiality of **Peaker Plant Obsolescence**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/peaker_plant_obsolescence.png]
