# Commodity Derivatives Volatility
...
![Chart](research_articles/2_Climate_Finance/images/commodity_derivatives_volatility.png)
...
Implementing **Commodity Derivatives Volatility** requires significant CAPEX, but the OPEX savings are non-linear.
