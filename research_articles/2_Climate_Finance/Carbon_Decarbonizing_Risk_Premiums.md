# Carbon Decarbonizing Risk Premiums
...
![Chart](research_articles/2_Climate_Finance/images/carbon_decarbonizing_risk_premiums.png)
...
Implementing **Carbon Decarbonizing Risk Premiums** requires significant CAPEX, but the OPEX savings are non-linear.
