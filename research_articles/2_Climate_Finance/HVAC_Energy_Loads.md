...
## 1. Executive Summary
This research note analyzes the financial materiality of **HVAC Energy Loads**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/hvac_energy_loads.png]
