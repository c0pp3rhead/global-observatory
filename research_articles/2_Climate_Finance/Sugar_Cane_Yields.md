...
## 1. Executive Summary
This research note analyzes the financial materiality of **Sugar Cane Yields**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/sugar_cane_yields.png]
