# Thermal Stress and GDP
**Author:** Cristian Morales | **Category:** 🌡 Thermal Stress & Labor

## 1. Executive Summary
This research note analyzes the financial materiality of **Thermal Stress and GDP**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/thermal_stress_and_gdp.png]
