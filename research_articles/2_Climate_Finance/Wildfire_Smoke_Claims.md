...
## 1. Executive Summary
This research note analyzes the financial materiality of **Wildfire Smoke Claims**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/wildfire_smoke_claims.png]
