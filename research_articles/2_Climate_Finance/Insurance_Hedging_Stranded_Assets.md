# Insurance Hedging Stranded Assets
...
![Chart](research_articles/2_Climate_Finance/images/insurance_hedging_stranded_assets.png)
...
Implementing **Insurance Hedging Stranded Assets** requires significant CAPEX, but the OPEX savings are non-linear.
