...
## 1. Executive Summary
This research note analyzes the financial materiality of **Olive Oil Drought**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/olive_oil_drought.png]
