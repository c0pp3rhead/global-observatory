# Carbon Stress-Testing Spot Markets
...
![Chart](research_articles/2_Climate_Finance/images/carbon_stress_testing_spot_markets.png)
...
Implementing **Carbon Stress-Testing Spot Markets** requires significant CAPEX, but the OPEX savings are non-linear.
