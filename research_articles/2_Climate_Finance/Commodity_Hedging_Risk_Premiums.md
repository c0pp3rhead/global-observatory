# Commodity Hedging Risk Premiums
...
![Chart](research_articles/2_Climate_Finance/images/commodity_hedging_risk_premiums.png)
...
Implementing **Commodity Hedging Risk Premiums** requires significant CAPEX, but the OPEX savings are non-linear.
