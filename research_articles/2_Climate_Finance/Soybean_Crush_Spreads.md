...
## 1. Executive Summary
This research note analyzes the financial materiality of **Soybean Crush Spreads**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/soybean_crush_spreads.png]
