# Supply Chain Auditing Spot Markets
...
![Chart](research_articles/2_Climate_Finance/images/supply_chain_auditing_spot_markets.png)
...
Implementing **Supply Chain Auditing Spot Markets** requires significant CAPEX, but the OPEX savings are non-linear.
