# Dengue Fever Lost Days
**Author:** Cristian Morales | **Category:** 🏥 Health Economics

## 1. Executive Summary
This research note analyzes the financial materiality of **Dengue Fever Lost Days**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/dengue_fever_lost_days.png]
