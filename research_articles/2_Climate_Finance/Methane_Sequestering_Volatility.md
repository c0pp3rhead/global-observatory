# Methane Sequestering Volatility
...
![Chart](research_articles/2_Climate_Finance/images/methane_sequestering_volatility.png)
...
Implementing **Methane Sequestering Volatility** requires significant CAPEX, but the OPEX savings are non-linear.
