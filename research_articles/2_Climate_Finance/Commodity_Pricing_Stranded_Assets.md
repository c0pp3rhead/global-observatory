# Commodity Pricing Stranded Assets
...
![Chart](research_articles/2_Climate_Finance/images/commodity_pricing_stranded_assets.png)
...
Implementing **Commodity Pricing Stranded Assets** requires significant CAPEX, but the OPEX savings are non-linear.
