# Solar Decarbonizing Futures Curves
...
![Chart](research_articles/2_Climate_Finance/images/solar_decarbonizing_futures_curves.png)
...
Implementing **Solar Decarbonizing Futures Curves** requires significant CAPEX, but the OPEX savings are non-linear.
