# Wind Forecasting Futures Curves
...
![Chart](research_articles/2_Climate_Finance/images/wind_forecasting_futures_curves.png)
...
Implementing **Wind Forecasting Futures Curves** requires significant CAPEX, but the OPEX savings are non-linear.
