# Carbon Auditing Transition Risks
...
![Chart](research_articles/2_Climate_Finance/images/carbon_auditing_transition_risks.png)
...
Implementing **Carbon Auditing Transition Risks** requires significant CAPEX, but the OPEX savings are non-linear.
