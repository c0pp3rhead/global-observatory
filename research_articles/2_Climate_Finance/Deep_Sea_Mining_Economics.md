...
## 1. Executive Summary
This research note analyzes the financial materiality of **Deep Sea Mining Economics**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/deep_sea_mining_economics.png]
