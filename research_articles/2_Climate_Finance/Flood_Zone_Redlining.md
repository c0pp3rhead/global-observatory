# Flood Zone Redlining
**Author:** Cristian Morales | **Category:** 🌪 Disaster Insurance

## 1. Executive Summary
This research note analyzes the financial materiality of **Flood Zone Redlining**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/flood_zone_redlining.png]
