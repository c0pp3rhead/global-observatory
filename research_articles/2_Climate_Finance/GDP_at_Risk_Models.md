...
## 1. Executive Summary
This research note analyzes the financial materiality of **GDP at Risk Models**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/gdp_at_risk_models.png]
