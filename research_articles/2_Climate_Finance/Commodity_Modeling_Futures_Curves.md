# Commodity Modeling Futures Curves
...
![Chart](research_articles/2_Climate_Finance/images/commodity_modeling_futures_curves.png)
...
Implementing **Commodity Modeling Futures Curves** requires significant CAPEX, but the OPEX savings are non-linear.
