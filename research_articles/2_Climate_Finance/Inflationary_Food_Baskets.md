# Inflationary Food Baskets
**Author:** Cristian Morales | **Category:** 📉 Macro-Economic Risk

## 1. Executive Summary
This research note analyzes the financial materiality of **Inflationary Food Baskets**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/inflationary_food_baskets.png]
