# Battery Sequestering Volatility
...
![Chart](research_articles/2_Climate_Finance/images/battery_sequestering_volatility.png)
...
Implementing **Battery Sequestering Volatility** requires significant CAPEX, but the OPEX savings are non-linear.
