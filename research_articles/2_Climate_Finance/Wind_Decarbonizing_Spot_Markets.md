# Wind Decarbonizing Spot Markets
...
![Chart](research_articles/2_Climate_Finance/images/wind_decarbonizing_spot_markets.png)
...
Implementing **Wind Decarbonizing Spot Markets** requires significant CAPEX, but the OPEX savings are non-linear.
