...
## 1. Executive Summary
This research note analyzes the financial materiality of **Heat Wave Hospitalizations**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/heat_wave_hospitalizations.png]
