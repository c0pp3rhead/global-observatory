# Disaster Resilience ROI
**Author:** Cristian Morales | **Category:** 🌪 Disaster Insurance

## 1. Executive Summary
This research note analyzes the financial materiality of **Disaster Resilience ROI**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/disaster_resilience_roi.png]
