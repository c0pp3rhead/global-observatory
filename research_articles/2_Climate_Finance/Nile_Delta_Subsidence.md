...
## 1. Executive Summary
This research note analyzes the financial materiality of **Nile Delta Subsidence**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/nile_delta_subsidence.png]
