# Telemedicine Carbon Footprint
**Author:** Cristian Morales | **Category:** 🏥 Health Economics

## 1. Executive Summary
This research note analyzes the financial materiality of **Telemedicine Carbon Footprint**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/telemedicine_carbon_footprint.png]
