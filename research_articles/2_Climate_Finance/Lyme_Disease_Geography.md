...
## 1. Executive Summary
This research note analyzes the financial materiality of **Lyme Disease Geography**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/lyme_disease_geography.png]
