...
## 1. Executive Summary
This research note analyzes the financial materiality of **Vector Borne Disease Expansion**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/vector_borne_disease_expansion.png]
