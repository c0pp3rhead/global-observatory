# Grid Decarbonizing Stranded Assets
...
![Chart](research_articles/2_Climate_Finance/images/grid_decarbonizing_stranded_assets.png)
...
Implementing **Grid Decarbonizing Stranded Assets** requires significant CAPEX, but the OPEX savings are non-linear.
