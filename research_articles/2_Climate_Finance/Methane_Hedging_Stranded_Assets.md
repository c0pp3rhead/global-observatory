# Methane Hedging Stranded Assets
...
![Chart](research_articles/2_Climate_Finance/images/methane_hedging_stranded_assets.png)
...
Implementing **Methane Hedging Stranded Assets** requires significant CAPEX, but the OPEX savings are non-linear.
