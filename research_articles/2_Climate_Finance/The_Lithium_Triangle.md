...
## 1. Executive Summary
This research note analyzes the financial materiality of **The Lithium Triangle**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/the_lithium_triangle.png]
