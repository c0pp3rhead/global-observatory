# Offset Quality Spreads
**Author:** Cristian Morales | **Category:** 📜 Carbon Markets

## 1. Executive Summary
This research note analyzes the financial materiality of **Offset Quality Spreads**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/offset_quality_spreads.png]
