# Insurance Auditing Spot Markets
...
![Chart](research_articles/2_Climate_Finance/images/insurance_auditing_spot_markets.png)
...
Implementing **Insurance Auditing Spot Markets** requires significant CAPEX, but the OPEX savings are non-linear.
