# Carbon Forecasting Risk Premiums
...
![Chart](research_articles/2_Climate_Finance/images/carbon_forecasting_risk_premiums.png)
...
Implementing **Carbon Forecasting Risk Premiums** requires significant CAPEX, but the OPEX savings are non-linear.
