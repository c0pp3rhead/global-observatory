# Crop Yield Put Options
**Author:** Cristian Morales | **Category:** 🌪 Disaster Insurance

## 1. Executive Summary
This research note analyzes the financial materiality of **Crop Yield Put Options**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/crop_yield_put_options.png]
