# Methane Arbitrage Futures Curves
...
![Chart](research_articles/2_Climate_Finance/images/methane_arbitrage_futures_curves.png)
...
Implementing **Methane Arbitrage Futures Curves** requires significant CAPEX, but the OPEX savings are non-linear.
