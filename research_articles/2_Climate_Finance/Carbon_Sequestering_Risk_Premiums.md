# Carbon Sequestering Risk Premiums
...
![Chart](research_articles/2_Climate_Finance/images/carbon_sequestering_risk_premiums.png)
...
Implementing **Carbon Sequestering Risk Premiums** requires significant CAPEX, but the OPEX savings are non-linear.
