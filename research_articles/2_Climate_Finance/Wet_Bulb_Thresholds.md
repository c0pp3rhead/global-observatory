...
## 1. Executive Summary
This research note analyzes the financial materiality of **Wet Bulb Thresholds**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/wet_bulb_thresholds.png]
