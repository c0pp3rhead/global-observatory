...
## 1. Executive Summary
This research note analyzes the financial materiality of **Copper Structural Deficit**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/copper_structural_deficit.png]
