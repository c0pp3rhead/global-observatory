# Solar Pricing Regulatory Shifts
...
![Chart](research_articles/2_Climate_Finance/images/solar_pricing_regulatory_shifts.png)
...
Implementing **Solar Pricing Regulatory Shifts** requires significant CAPEX, but the OPEX savings are non-linear.
