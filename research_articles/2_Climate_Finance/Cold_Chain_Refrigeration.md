...
## 1. Executive Summary
This research note analyzes the financial materiality of **Cold Chain Refrigeration**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/cold_chain_refrigeration.png]
