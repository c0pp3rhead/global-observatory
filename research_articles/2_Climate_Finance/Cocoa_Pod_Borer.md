...
## 1. Executive Summary
This research note analyzes the financial materiality of **Cocoa Pod Borer**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/cocoa_pod_borer.png]
