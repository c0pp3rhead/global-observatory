# Aquifer Arbitrage Risk Premiums
...
![Chart](research_articles/2_Climate_Finance/images/aquifer_arbitrage_risk_premiums.png)
...
Implementing **Aquifer Arbitrage Risk Premiums** requires significant CAPEX, but the OPEX savings are non-linear.
