# Insurance Hedging Transition Risks
...
![Chart](research_articles/2_Climate_Finance/images/insurance_hedging_transition_risks.png)
...
Implementing **Insurance Hedging Transition Risks** requires significant CAPEX, but the OPEX savings are non-linear.
