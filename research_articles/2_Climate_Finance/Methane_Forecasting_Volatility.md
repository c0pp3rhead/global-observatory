# Methane Forecasting Volatility
...
![Chart](research_articles/2_Climate_Finance/images/methane_forecasting_volatility.png)
...
Implementing **Methane Forecasting Volatility** requires significant CAPEX, but the OPEX savings are non-linear.
