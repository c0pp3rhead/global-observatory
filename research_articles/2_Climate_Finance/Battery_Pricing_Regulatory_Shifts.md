# Battery Pricing Regulatory Shifts
...
![Chart](research_articles/2_Climate_Finance/images/battery_pricing_regulatory_shifts.png)
...
Implementing **Battery Pricing Regulatory Shifts** requires significant CAPEX, but the OPEX savings are non-linear.
