# Climate Migration Housing Impacts
**Author:** Cristian Morales | **Category:** 📉 Macro-Economic Risk

## 1. Executive Summary
This research note analyzes the financial materiality of **Climate Migration Housing Impacts**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/climate_migration_housing_impacts.png]
