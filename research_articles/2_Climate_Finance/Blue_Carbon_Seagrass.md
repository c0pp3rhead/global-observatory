...
## 1. Executive Summary
This research note analyzes the financial materiality of **Blue Carbon Seagrass**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/blue_carbon_seagrass.png]
