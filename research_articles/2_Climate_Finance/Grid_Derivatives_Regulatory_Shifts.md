# Grid Derivatives Regulatory Shifts
...
![Chart](research_articles/2_Climate_Finance/images/grid_derivatives_regulatory_shifts.png)
...
Implementing **Grid Derivatives Regulatory Shifts** requires significant CAPEX, but the OPEX savings are non-linear.
