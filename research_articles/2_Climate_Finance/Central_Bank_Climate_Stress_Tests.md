...
## 1. Executive Summary
This research note analyzes the financial materiality of **Central Bank Climate Stress Tests**. As volatility increases in the physical biosphere, traditional risk models (VaR) fail to capture these "Fat Tail" events.
...
[IMAGE: images/central_bank_climate_stress_tests.png]
