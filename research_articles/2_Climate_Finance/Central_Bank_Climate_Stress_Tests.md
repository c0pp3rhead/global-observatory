...
**Category:** Macro | **Read Time:** 5 min

## 🎓 Concept 101: The Basics
*Banks checking if they would go bankrupt if a massive climate disaster happened.*

---

## 1. Technical Abstract
This research note evaluates **Central Bank Climate Stress Tests** within the context of Macro. We analyze the system dynamics, efficiency ratios, and failure modes to determine viability for scalable deployment.
...
## 3. Data Analysis
![Chart](images/central_bank_climate_stress_tests.png)
